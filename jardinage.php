...
$apiLinkJardinage = 'https://api.dailymotion.com/videos?fields=description,embed_url,embed_html,thumbnail_url,title,comments_total,views_total,&channel=lifestyle&detected_language=fr&tags=jardinage+tuto+tutoriel&limit=10';
$request = file_get_contents($apiLinkJardinage);
$requestDecode = json_decode($request);


echo "<h1>Tuto Jardin :</h1>";
