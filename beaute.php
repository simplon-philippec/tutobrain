...
$apiLinkBeaute = 'https://api.dailymotion.com/videos?fields=description,embed_url,embed_html,thumbnail_url,title,comments_total,views_total,&channel=lifestyle&detected_language=fr&tags=beaute+tuto+tutoriel&limit=10';
$request = file_get_contents($apiLinkBeaute);
$requestDecode = json_decode($request);

echo "<h1>Tuto Beauté:</h1>";
